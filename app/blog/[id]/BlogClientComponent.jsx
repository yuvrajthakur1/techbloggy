...
//   return (
//     <div className="min-h-screen bg-[#E7F2EF] px-4 sm:px-6 md:px-8 lg:px-12 py-12">
//       <motion.div
  ...
  return (
    <div className="min-h-screen bg-[#E7F2EF] px-4 sm:px-6 md:px-8 lg:px-12 py-12">
      ...
      >
        ...
        {/* Blog Image */}
        {blog.image && (
          <div className="relative w-full h-64 sm:h-80 md:h-96 rounded-xl overflow-hidden mb-10 shadow-xl">
            <Image
              src={blog.image?.url}
              alt={blog.title}
              fill
        ...
        {/* Markdown Content — more spacious */}
        <div className="prose prose-invert max-w-full text-[#E7F2EF] leading-relaxed mb-10">
          <ReactMarkdown
            components={{
              p: ({ children }) => (
                <p className="mb-6 leading-8 tracking-wide text-[#E7F2EF]/90">
                  {children}
                </p>
              ),
              h2: ({ children }) => (
                <h2 className="text-2xl sm:text-3xl font-bold mt-10 mb-4 text-[#A1C2BD] border-b border-[#708993]/40 pb-1">
                  {children}
                </h2>
              ),
              h3: ({ children }) => (
                <h3 className="text-xl font-semibold mt-8 mb-3 text-[#A1C2BD]">
                  {children}
                </h3>
              ),
              li: ({ children }) => (
                <li className="mb-2 list-disc list-inside text-[#E7F2EF]/90">
                  {children}
                </li>
              ),
              code({ node, inline, className, children, ...props }) {
