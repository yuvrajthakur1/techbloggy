...
export default function BlogCard({ blog }) {
  ...
  return (
    <div className="flex flex-col bg-[#19183B]   rounded-2xl shadow-2xl border border-[#708993]/50 overflow-hidden group hover:scale-[1.03] transition-transform duration-300">
