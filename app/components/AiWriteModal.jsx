...
// export default function AIWriterModal({ open, onClose }) {
...
//       <div className="relative bg-[#1a1a1a] w-full max-w-3xl rounded-xl p-6 border border-[#2a2a2a] shadow-xl max-h-[90vh] overflow-y-auto transition-all duration-300">
...
//         {/* Header */}
//         <h3 className="text-xl font-semibold text-gray-200 mb-5 text-center">
//           🧠 AI Blog Writer
//         </h3>
...
//             className="p-3 rounded-lg bg-[#262626] text-gray-100 border border-[#333] focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all"
//           />
...
//               className="p-3 rounded-lg bg-[#262626] text-gray-100 border border-[#333] focus:ring-2 focus:ring-gray-500 w-32"
//             />
//             <select
//               value={tone}
//               onChange={(e) => setTone(e.target.value)}
//               className="p-3 rounded-lg bg-[#262626] text-gray-100 border border-[#333] focus:ring-2 focus:ring-gray-500"
//             >
...
//               disabled={loading}
//               className="ml-auto bg-[#3d3d3d] hover:bg-[#4a4a4a] text-gray-100 px-5 py-2 rounded-lg transition-all"
//             >
...
//         {/* Output Section */}
//         <div>
//           <h4 className="text-sm text-gray-400 mb-2">📝 Preview (Markdown)</h4>
//           <div className="bg-[#1e1e1e] text-gray-100 p-4 rounded-lg max-h-64 overflow-y-auto border border-[#2a2a2a]">
//             {markdown ? (
//               <ReactMarkdown>{markdown}</ReactMarkdown>
//             ) : (
//               <p className="text-gray-500 italic">
//                 No output yet — click <span className="text-gray-300">Generate</span>.
//               </p>
//             )}
//           </div>
...
//               disabled={!markdown}
//               className="bg-[#2e2e2e] hover:bg-[#3a3a3a] text-gray-100 px-5 py-2 rounded-lg transition-all"
//             >
//               Copy Markdown
//             </Button>
//             <Button
...
//           {/* Tip Section */}
//           {markdown && (
//             <p className="text-gray-400 text-sm mt-4 border-t border-[#2a2a2a] pt-3">
